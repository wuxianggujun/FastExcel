...
macro(clone_repo name url tag)
    ...
    if(${CMAKE_VERSION} VERSION_LESS "3.11")
        ...
        # Use FetchContent_MakeAvailable instead of FetchContent_Populate for CMake 3.30+ compatibility
        if(${CMAKE_VERSION} VERSION_GREATER_EQUAL "3.30")
            # For CMake 3.30+, use FetchContent_MakeAvailable directly
            FetchContent_MakeAvailable(${name})
            set(${name_upper}_SOURCE_DIR ${${name_lower}_SOURCE_DIR})
            set(${name_upper}_BINARY_DIR ${${name_lower}_BINARY_DIR})
        else()
            # For older CMake versions, use the traditional approach
